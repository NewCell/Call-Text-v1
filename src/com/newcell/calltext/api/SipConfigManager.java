...
public class SipConfigManager {
     ...
     * Let newcell automatically manage this setting if you want auto
     * detection to work
     * 
     * @see #setPreferenceBooleanValue(Context, String, boolean)
     */
     ...
     */
    public static final String AUTHORITY = "com.newcell.calltext.prefs";
    //private static final String BASE_DIR_TYPE = "vnd.android.cursor.dir/vnd.csipsimple";
    private static final String BASE_DIR_TYPE = "vnd.android.cursor.dir/vnd.newcell";
    //private static final String BASE_ITEM_TYPE = "vnd.android.cursor.item/vnd.csipsimple";
    private static final String BASE_ITEM_TYPE = "vnd.android.cursor.item/vnd.newcell";
    ...
    /**
     * Helper method to retrieve a newcell string config value
     * 
    ...
    /**
     * Helper method to retrieve a newcell boolean config value
     * 
     * @param ctxt The context of your app
     * @param key the key for the setting you want to get
     * @param defaultValue the value you want to return if nothing found
    ...
    /**
     * Helper method to retrieve a newcell float config value
     * 
     * @param ctxt The context of your app
     * @param key the key for the setting you want to get
     * @param defaultValue the value you want to return if nothing found
