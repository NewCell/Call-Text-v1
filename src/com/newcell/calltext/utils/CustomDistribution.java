...
package com.newcell.calltext.utils;
...
public final class CustomDistribution {
	...
	public static String getSupportEmail() {
		/*
		 * TODO:: Change to NewCell email
		 */
		return "support@newcellsolutions.com";
	}
	
	/**
	 * Phone number for customer care
	 * @return The phone number for NewCell customer care
	 */
	...
	public static String getFaqLink() {
		...
		return "https://www.newcellsolutions.com/faq/";
	}
	
	/**
	 * Get the link to the Legal page. If null or empty the link to Legal is not displayed
	 * @return link to the Legal page
	 */
	public static String getLegalLink() {
		/* 
		 * TODO:: Get Legal http page
		 */
	...
	/**
	 * Shall we force the no multiple call feature to be set to false
