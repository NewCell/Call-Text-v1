...
package com.newcell.calltext.service;
...
import com.newcell.calltext.api.ISipConfiguration;
...
import com.newcell.calltext.db.DBProvider;
import com.newcell.calltext.models.Filter;
import com.newcell.calltext.pjsip.PjSipCalls;
import com.newcell.calltext.pjsip.PjSipService;
import com.newcell.calltext.pjsip.UAStateReceiver;
import com.newcell.calltext.service.receiver.DynamicReceiver4;
import com.newcell.calltext.service.receiver.DynamicReceiver5;
import com.newcell.calltext.ui.incall.InCallMediaControl;
import com.newcell.calltext.utils.Compatibility;
import com.newcell.calltext.utils.CustomDistribution;
import com.newcell.calltext.utils.ExtraPlugins;
import com.newcell.calltext.utils.ExtraPlugins.DynActivityPlugin;
...
//		connectivityManager = (ConnectivityManager) getSystemService(Context.CONNECTIVITY_SERVICE);
	...
	private void applyComponentEnablingState(boolean active) {
        ...
        ComponentName cmp = new ComponentName(this, "com.newcell.calltext.ui.PrivilegedOutgoingCallBroadcaster");
        try {
