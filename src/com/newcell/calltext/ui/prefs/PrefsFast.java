...
//		updateFromPrefs();
	...
	/**
	 * Apply the preferences we want to use for NewCell, and then close the dialog
	 */
	private void applyNewcellPrefs() {
		
		globIntegrate.performClick();
		globProfileAlways.performClick();
		globGsm.setChecked(true);
		
		// Simulate button press of "Save" to apply preferences
