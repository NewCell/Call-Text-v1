...
package com.newcell.calltext.ui.prefs;
...
public class PrefsLogic {
    ...
    public static boolean onMainActivityOptionsItemSelected(MenuItem item, Context ctxt, PreferencesWrapper prefsWrapper) {
        ...
        if (id == R.id.audio_test) {
            ...
            return true;
        /*
         * 6/10/2014 Added for Account Settings settings menu item
         */
        } else if(id == R.id.account_settings) {
        	// Open the account settings for the user
        	ArrayList<SipProfile> accounts;
        	accounts = SipProfile.getAllProfiles(ctxt, true, new String[] {
        			SipProfile.FIELD_ID
        	});
        	...
        	intent.setClass(ctxt, BasePrefsWizard.class);
        ...
        /*
         * 6/10/2014 Removed to simplify Settings menu
         */
