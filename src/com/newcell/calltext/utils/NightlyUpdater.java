...
import com.newcell.calltext.service.DeviceStateReceiver;
import com.newcell.calltext.service.Downloader;
...
public class NightlyUpdater {
	...
	public class UpdaterPopupLauncher implements Runnable {
		...
		public void run() {
			...
			ab.setIcon(R.drawable.ic_launcher_phone)
				...
				ab.setMessage("Revision " + version + " available. Upgrade now?")
					.setPositiveButton(R.string.ok, new OnClickListener() {
						...
						public void onClick(DialogInterface dialog, int which) {
							...
							it.putExtra(Downloader.EXTRA_ICON, R.drawable.ic_launcher_phone);
