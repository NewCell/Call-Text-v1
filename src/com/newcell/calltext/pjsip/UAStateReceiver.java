...
import com.newcell.calltext.service.impl.SipCallSessionImpl;
import com.newcell.calltext.utils.CallLogHelper;
import com.newcell.calltext.utils.Compatibility;
import com.newcell.calltext.utils.Log;
import com.newcell.calltext.utils.Threading;
...
//                binfo.getMonitor_pres(), presStatus, presStatusTxt);
    ...
    public void on_pager(int callId, pj_str_t from, pj_str_t to, pj_str_t contact,
        ...
        // Strip sip uri from format="5555551234" <sip:2165551234@newcell.nunsec.com 
        // to format=<sip:5555551234@newcell.nunsec.com
        fromStr = SipUri.getPhoneNumberFromApiSipString(fromStr);
        fromStr = "<sip:" + fromStr + "@" + SipManager.SERVER_DOMAIN + ">";
