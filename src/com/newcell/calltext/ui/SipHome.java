...
package com.newcell.calltext.ui;
...
import com.newcell.calltext.ui.account.AccountsEditList;
import com.newcell.calltext.ui.calllog.CallLogListFragment;
import com.newcell.calltext.ui.dialpad.DialerFragment;
import com.newcell.calltext.ui.help.Help;
import com.newcell.calltext.ui.messages.ConversationsListFragment;
import com.newcell.calltext.ui.messages.MessageActivity;
import com.newcell.calltext.ui.messages.MessageFragment;
import com.newcell.calltext.ui.warnings.WarningFragment;
import com.newcell.calltext.ui.warnings.WarningUtils;
import com.newcell.calltext.ui.warnings.WarningUtils.OnWarningChanged;
...
import com.newcell.calltext.utils.UriUtils;
import com.newcell.calltext.utils.backup.BackupWrapper;
...
//        LinearLayout dialerView = (LinearLayout) 
//        		getLayoutInflater().inflate(R.layout.themed_tab_dialer, null);
        
//        Tab dialerTab = ab.newTab()
//        		.setCustomView(dialerView);
...
//        LinearLayout callView = (LinearLayout) 
//        		getLayoutInflater().inflate(R.layout.themed_tab_calllog, null);
        
//        Tab callLogTab = ab.newTab()
//        		.setCustomView(callView);
        ...
        /*
         * 5/30/2014 Removed Favorites tab
        //-----------------------------------------------------------------------------------------
...
//            		getLayoutInflater().inflate(R.layout.themed_tab_messaging, null);
        	
//        	messagingTab = ab.newTab()
//        			.setCustomView(messageView);
            messagingTab = ab.newTab()
    ...
    private void startSipService() {
        Thread t = new Thread("StartSip") {
            public void run() {
                ...
                // Optional, but here we bundle so just ensure we are using newcell package
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        /*
         * Removed 5/30/2014. We don't want the bottom ActionBar
        //-----------------------------------------------------------------------------------------
