...
import com.newcell.calltext.widgets.EditSipUri;
import com.newcell.calltext.widgets.EditSipUri.ToCall;
...
public class PickupSipUri extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/*
		 * Set the title to 'Recipient:'
		 */
		setTitle(R.string.recipient_label);
