...
public final class SipManager {
     ...
     */
    public static final String INTENT_SIP_CONFIGURATION = "com.newcell.calltext.service.SipConfiguration";
    /**
     ...
     */
    public static final String INTENT_SIP_SERVICE = "com.newcell.calltext.service.SipService";
     ...
     * </p>
     */
    public static final String INTENT_SIP_ACCOUNT_ACTIVATE = "com.newcell.calltext.accounts.activate";
    ...
    /**
     * Scheme for newcell uri
     */
    public static final String PROTOCOL_CALLTEXT = "calltext";
    /**
     * Scheme for sip uri.
     */
     ...
     * </p>
     */
    public static final String ACTION_SIP_CALL_UI = "com.newcell.calltext.phone.action.INCALL";
    /**
     * Action launched when the status icon clicked.<br/>
     * Should raise the dialer.
     */
    public static final String ACTION_SIP_DIALER = "com.newcell.calltext.phone.action.DIALER";
    /**
     * Action launched when a missed call notification entry is clicked.<br/>
     * Should raise call logs list.
     */
    public static final String ACTION_SIP_CALLLOG = "com.newcell.calltext.phone.action.CALLLOG";
    /**
     * Action launched when a sip message notification entry is clicked.<br/>
     * Should raise the sip message list.
     */
    public static final String ACTION_SIP_MESSAGES = "com.newcell.calltext.phone.action.MESSAGES";
    /**
     * Action launched when user want to go in sip favorites.
     * Should raise the sip favorites view.
     */
    public static final String ACTION_SIP_FAVORITES = "com.newcell.calltext.phone.action.FAVORITES";
    /**
     * Action launched to enter fast settings.<br/>
     */
    public static final String ACTION_UI_PREFS_FAST = "com.newcell.calltext.ui.action.PREFS_FAST";
    /**
     * Action launched to enter global newcell settings.<br/>
     */
    public static final String ACTION_UI_PREFS_GLOBAL = "com.newcell.calltext.ui.action.PREFS_GLOBAL";
     ...
     * </p>
     */
    public static final String ACTION_SIP_CALL_LAUNCH = "com.newcell.calltext.service.CALL_LAUNCHED";
    /**
     ...
     * </p>
     */
    public static final String ACTION_SIP_CALL_CHANGED = "com.newcell.calltext.service.CALL_CHANGED";
    /**
     ...
     * </p>
     */
    public static final String ACTION_SIP_ACCOUNT_CHANGED = "com.newcell.calltext.service.ACCOUNT_CHANGED";
    /**
     ...
     * </p>
     */
    public static final String ACTION_SIP_ACCOUNT_DELETED = "com.newcell.calltext.service.ACCOUNT_DELETED";
    /**
     ...
     * </p>
     */
    public static final String ACTION_SIP_REGISTRATION_CHANGED = "com.newcell.calltext.service.REGISTRATION_CHANGED";
    /**
     * Broadcast sent when the state of device media has been changed.
     */
    public static final String ACTION_SIP_MEDIA_CHANGED = "com.newcell.calltext.service.MEDIA_CHANGED";
    /**
     * Broadcast sent when a ZRTP SAS
     */
    public static final String ACTION_ZRTP_SHOW_SAS = "com.newcell.calltext.service.SHOW_SAS";
    /**
     ...
     */
    public static final String ACTION_SIP_MESSAGE_RECEIVED = "com.newcell.calltext.service.MESSAGE_RECEIVED";
    /**
     ...
     * </p>
     */
    public static final String ACTION_SIP_CALL_RECORDED = "com.newcell.calltext.service.CALL_RECORDED";

    // REGISTERED BROADCASTS
    /**
     * Broadcast to send when the sip service can be stopped.
     */
    public static final String ACTION_SIP_CAN_BE_STOPPED = "com.newcell.calltext.service.ACTION_SIP_CAN_BE_STOPPED";
    /**
     * Broadcast to send when the sip service should be restarted.
     */
    public static final String ACTION_SIP_REQUEST_RESTART = "com.newcell.calltext.service.ACTION_SIP_REQUEST_RESTART";
    /**
     ...
     * @see #EXTRA_OUTGOING_ACTIVITY
     */
    public static final String ACTION_OUTGOING_UNREGISTER = "com.newcell.calltext.service.ACTION_OUTGOING_UNREGISTER";
    /**
     ...
     * @see #EXTRA_OUTGOING_ACTIVITY
     */
    public static final String ACTION_DEFER_OUTGOING_UNREGISTER = "com.newcell.calltext.service.ACTION_DEFER_OUTGOING_UNREGISTER";

    // PLUGINS BROADCASTS
    /**
     * Plugin action for themes.
     */
    public static final String ACTION_GET_DRAWABLES = "com.newcell.calltext.themes.GET_DRAWABLES";
    /**
     ...
     * </ul>
     */
    public static final String ACTION_GET_PHONE_HANDLERS = "com.newcell.calltext.phone.action.HANDLE_CALL";
     ...
     */
    public static final String ACTION_INCALL_PLUGIN = "com.newcell.calltext.sipcall.action.HANDLE_CALL_PLUGIN";
    
    public static final String EXTRA_SIP_CALL_MIN_STATE = "com.newcell.calltext.sipcall.MIN_STATE";
    public static final String EXTRA_SIP_CALL_MAX_STATE = "com.newcell.calltext.sipcall.MAX_STATE";
    public static final String EXTRA_SIP_CALL_CALL_WAY = "com.newcell.calltext.sipcall.CALL_WAY";
     ...
     * </ul>
     */
    public final static String ACTION_REWRITE_NUMBER = "com.newcell.calltext.phone.action.REWRITE_NUMBER"; 
    /**
     * Plugin action for audio codec.
     */
    public static final String ACTION_GET_EXTRA_CODECS = "com.newcell.calltext.codecs.action.REGISTER_CODEC";
    /**
     * Plugin action for video codec.
     */
    public static final String ACTION_GET_EXTRA_VIDEO_CODECS = "com.newcell.calltext.codecs.action.REGISTER_VIDEO_CODEC";
    /**
     * Plugin action for video.
     */
    public static final String ACTION_GET_VIDEO_PLUGIN = "com.newcell.calltext.plugins.action.REGISTER_VIDEO";
    /**
     ...
     */
    public static final String AUTHORITY = "com.newcell.calltext.db";
    /**
     * Base content type for newcell objects.
     */
    public static final String BASE_DIR_TYPE = "vnd.android.cursor.dir/vnd.newcell";
    /**
     * Base item content type for newcell objects.
     */
    public static final String BASE_ITEM_TYPE = "vnd.android.cursor.item/vnd.newcell";
    ...
    // ---------------------
    // VOIP SERVER CONSTANTS
    /**
     * Constant for the server domain to VOIP server
     */
    //public static final String SERVER_DOMAIN = "enswitch1.t1co.net";
    //public static final String SERVER_DOMAIN = "74.63.41.218";
    public static final String SERVER_DOMAIN = "newcell.nunsec.com";
    /**
     * VoIP API call to get client information
     */
    public static final String API_USER_INFO =
    		"http://newcellapi.nunsec.com/api/v1.0/voip_server/user_information/";
    /**
     * VoIP API call to request AuthKey and AuthPass
     */
    public static final String API_REQUEST_AUTH = 
    		"http://newcellapi.nunsec.com/api/v1.0/voip_server/auth/";
