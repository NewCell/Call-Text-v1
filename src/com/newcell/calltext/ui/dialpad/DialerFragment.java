...
package com.newcell.calltext.ui.dialpad;
...
import com.newcell.calltext.models.Filter;
import com.newcell.calltext.plugins.telephony.CallHandler;
import com.newcell.calltext.ui.SipHome.ViewPagerVisibilityListener;
import com.newcell.calltext.ui.dialpad.DialerLayout.OnAutoCompleteListVisibilityChangedListener;
import com.newcell.calltext.utils.CallHandlerPlugin;
import com.newcell.calltext.utils.CallHandlerPlugin.OnLoadListener;
...
import com.newcell.calltext.utils.contacts.ContactsSearchAdapter;
import com.newcell.calltext.widgets.AccountChooserButton;
import com.newcell.calltext.widgets.AccountChooserButton.OnAccountChangeListener;
import com.newcell.calltext.widgets.DialerCallBar;
import com.newcell.calltext.widgets.DialerCallBar.OnDialActionListener;
import com.newcell.calltext.widgets.Dialpad;
import com.newcell.calltext.widgets.Dialpad.OnDialKeyListener;
...
//            	digits.setText("*86");
//            	placeCall();
                placeVMCall();  // 08/05/2014 Changed long hold 1 to just call *86 (voicemail)
                return true;
            }
        }
        return false;
    ...
    private void placeCallWithOption(Bundle b) {
        ...
        /*
         * Check for special phone numbers ie. *228
         * If found, call using gsm
         */
        if(toCall.equals("*228")) {
        	Intent intent = new Intent(Intent.ACTION_CALL);
        	intent.setData(Uri.parse("tel:" + toCall));
