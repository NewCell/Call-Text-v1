...
package com.newcell.calltext.utils.contacts;
...
public class ContactsUtils5 extends ContactsWrapper {
    ...
    /* (non-Javadoc)
     * @see com.newcell.utils.contacts.ContactsWrapper#isExternalPhoneNumber(android.content.Context, android.database.Cursor)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.newcell.utils.contacts.ContactsWrapper#bindContactPhoneView(android.view.View, android.content.Context, android.database.Cursor)
     */
    @Override
...
//            csipProto.put(CommonDataKinds.Im.DATA, SipUri.getCanonicalSipContact(csipUri, false));
            csipProto.put(Data.MIMETYPE, CommonDataKinds.Phone.CONTENT_ITEM_TYPE);
            csipProto.put(CommonDataKinds.Phone.DATA, SipUri.getCanonicalSipContact(csipUri, false));
            data.add(csipProto);
