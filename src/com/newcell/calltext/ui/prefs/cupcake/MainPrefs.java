...
package com.newcell.calltext.ui.prefs.cupcake;
...
public class MainPrefs extends SherlockListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		prefs_list.add(new PrefGroup(R.string.prefs_account_settings, R.string.prefs_account_settings_desc,
				R.drawable.ic_prefs_account, getAccountSettingsIntent()));
