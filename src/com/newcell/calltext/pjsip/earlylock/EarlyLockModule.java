...
package com.newcell.calltext.pjsip.earlylock;
...
import com.newcell.calltext.pjsip.PjSipService.PjsipModule;
...
public class EarlyLockModule implements PjsipModule {
     ...
     * (non-Javadoc)
     * @see
     * com.newcell.pjsip.PjSipService.PjsipModule#setContext(android.content
     * .Context)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.newcell.pjsip.PjSipService.PjsipModule#onBeforeStartPjsip()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.newcell.pjsip.PjSipService.PjsipModule#
     * onBeforeAccountStartRegistration(int, com.newcell.api.SipProfile)
     */
    @Override
